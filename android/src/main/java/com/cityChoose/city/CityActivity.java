...
public class CityActivity extends Activity implements OnScrollListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.citychoose_main);
		getCurrentCity();
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 4) {
					sendData(allCity_lists.get(position).getName());
...
//							Toast.LENGTH_SHORT).show();
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
									int position, long id) {
				sendData(city_result.get(position).getName());
//				Toast.makeText(getApplicationContext(),
...
//						.show();
	...
	private void getCurrentCity(){
		...
		if(currentCity==null||currentCity=="-1"||currentCity==""){
			locateProcess=1;
			//定位处理
		}else{
			locateProcess=2;
...
//									Toast.LENGTH_SHORT).show();
				...
				rencentCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
											int position, long id) {
						sendData(city_history.get(position));
//						Toast.makeText(getApplicationContext(),
...
//								.show();
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
											int position, long id) {
						sendData(city_hot.get(position).getName());
//						Toast.makeText(getApplicationContext(),
